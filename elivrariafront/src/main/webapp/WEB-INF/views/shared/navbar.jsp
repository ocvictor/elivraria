        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li id="sobre" style="font-size:13px">
                        <a href="${contextRoot}/sobre">Sobre</a>
                    </li>

                    <li id="contato" style="font-size:13px">
                        <a href="${contextRoot}/contato">Contato</a>
                    </li>
                    
                    <li id="listarLivros" style="font-size:13px">
                        <a href="${contextRoot}/mostrar/todos/livros">Livros</a>
                    </li>
					<security:authorize access="hasAuthority('ADMIN')">
	                    <li id="gerenciarLivro" style="font-size:13px">
	                        <a href="${contextRoot}/gerenciar/livro">Gerenciar Livros</a>
	                    </li>					
					</security:authorize>
					<security:authorize access="hasAuthority('ADMIN')">
	                    <li id="gerenciarUsuario" style="font-size:13px">
	                        <a href="${contextRoot}/gerenciar/usuario"> Usuarios</a>
	                    </li>					
					</security:authorize>
					<security:authorize access="hasAuthority('ADMIN')">
	                    <li id="gerenciarEstoque" style="font-size:13px">
	                        <a href="${contextRoot}/gerenciar/estoque"> Estoque</a>
	                    </li>					
					</security:authorize>
					<security:authorize access="hasAuthority('ADMIN')">
	                    <li id="gerenciarVendas" style="font-size:13px">
	                        <a href="${contextRoot}/gerenciar/vendas"> Vendas</a>
	                    </li>					
					</security:authorize>
					<security:authorize access="hasAuthority('ADMIN')">
	                    <li id="gerenciarTrocasCancelamentos" style="font-size:13px">
	                        <a href="${contextRoot}/gerenciar/trocasCancelamentos"> Trocas</a>
	                    </li>					
					</security:authorize>
					<security:authorize access="hasAuthority('ADMIN')">
	                    <li id="gerenciarRelatorios" style="font-size:13px">
	                        <a href="${contextRoot}/gerenciar/relatorios">Relatórios</a>
	                    </li>					
					</security:authorize>
                </ul>
